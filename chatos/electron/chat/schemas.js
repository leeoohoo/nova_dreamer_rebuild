...
export const chatSessionSchema = z.object({
  ...
  mode: z.enum(['session', 'room']).optional().default('session'),
  hostAgentId: z.string().trim().optional().default(''),
  memberAgentIds: z.array(z.string().trim()).optional().default([]),
  roomPrompt: z.string().optional().default(''),
  workspaceRoot: z.string().trim().optional().default(''),
